...
var term = $('#terminal').terminal(function(command, term) {
    ...
    if (cmd.name === 'exit') {
        ...
        term.echo('[[b;#fff;]PENTEST] - [[b;#fff;]Mon amour pour la cybersécurité se retrouve au quotidien lorsque j\'étoffe mes compétences sur des sites spécialisés comme tryhack me, root-me ou encore hack the box\noù j\'ai atteint déjà un bon niveau, 7000 ème sur root-me, et 61172 ème sur 156 521 5 utilisateurs try hack me. Il vous est possible de me retrouver sur certains capture the flag\ncomme celui de la DGSE, le FSCE france cyber security challenge. Ce sont des challenges de piratage où il faut infecter une machine hôte et récupérer des "flags", un pour l\'utilisateur et un "root" pour le system.\nJe prépare en amont quelques certifications comme l\'EJPT, le CEH ainsi que la pentest + de comptia. Dans cette optique la j\'utilise très souvent des outils tels que netcat, aircrack\njohn the ripper, hydra, wireshark et bien d\'autres. Je parcours de nombreux sites tels que github et stack overflow qui me permettent l\'accès à une très large base de connaissance, et utilise des langages de programmation\ntels que batch, powershell, python, html, css ou encore php.\n\n]');
